...
class DynamicMonitor(object):
    ...
    def __init__(self, simulation_resolution):
        ...
        self._ultrawide_configs = {
            ...
            "3840x2160": {"split_count": 1, "split_width": 3840, "split_height": 2160}
        }
    ...
    def get_monitor_layout(self):
        ...
        name, resolution, position, primary status, refresh rate, and ultra-wide detection.
        ...
        try:
            ...
            for block in monitor_blocks:
                ...
                monitor_data = {
                    ...
                    "ultrawide_config": ultrawide_config
                }
                
                monitors.append(monitor_data)
                
                print(f"📺 Detected: {monitor_data['name']} @ {resolution_str} (AR: {aspect_ratio:.2f}) {'[ULTRA-WIDE]' if is_ultrawide else ''}")
    ...
    def arrange_monitors_for_panoramic(self, target_resolution, monitors):
        ...
        for i, monitor in enumerate(monitors):
            ...
            if monitor['resolution_str'] == "7680x2160":
                ...
                # For other splits, use target width * split count
                current_x_pos += target_w * split_count
            else:
                # Standard monitor uses target width
                current_x_pos += target_w
                
            if split_count > 1:
                print(f"    └─ Spans {split_count} logical displays")
