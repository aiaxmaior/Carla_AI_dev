...
def consolidated_select_screen(
    ...
    # Use the passed-in panel info to correctly calculate the center.
    ...
    # Starting Y position as a ratio of the screen height (this is already good!)
    y0 = _panel_h * 0.20
    ...
    # The width and X position of the UI panel (your existing code is good)
    w = int(_panel_w * 0.8)
    x = panel_x0 + (_panel_w - w) // 2
...
#       )
        ...
        display.blit(prompt, (center_x - prompt.get_width() // 2, 120))
