...
class Perception:
    ...
    def compute(self, max_objects=32, include_2d=False):
        """
        ...
        for a in self.world.get_actors().filter("*"):
            ...
            cls = "vehicle" if t.startswith("vehicle.") else ("pedestrian" if t.startswith("walker.pedestrian.") else "other")
