...
class DualControl(object):
    ...
    def __init__(self, world_instance, args, existing_mappings=None, map_keys=None, display_height=None):
        ...
        self._seatbelt_state = False
        self._seatbelt_initial_state = 0
        ...
        if joystick_count == 0:                               #⠀⠀⠀⠀⠀⠀⠀⠀⣰⠟⠉⠀⠀⠉⠙⠻⣶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣰⠟⠉⠀⠀  ⠉⠙⠻⣶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣰⠟⠉⠀⠀    ⠙⣶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
            ...
            logging.warning("no js detected!")                # ⠀⠀⠀⠀⠀⠀⠀⠀⠈⠂⠀⠀⠀⢹⡇⠀⠀⠀⠹⣷⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠂⠀⠀⠀⢹⡇⠀ ⠀⠀⠹⣷⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈   ⠀ ⢹⡇⠀⠀⠀ ⠹⣷⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                                                              #⠀⠀⠀ ⠀⣀⣠⣤⣀⣀⣀⣀⣀⣠⣿⠃⠀⠀⠀⠀⠈⠻⣦⣀⠀ ⠀ ⣀⣠⣤⣀⣀⣀⣀⣠⣿⠃⠀⠀ ⠀⠀⠈⠻⣦⣀⠀⠀⠀⣀⣠⣤⣀⣀⣀⣀⣀⣠⣿⠃⠀⠀⠀⠀ ⠈⠻⣦⣀⠀⠀⠀⠀⠀⠀⠀
        else:                                                 #⠀⠀⠀  ⠀⠀⠀⠈⠉⠛⠛⠛⠉⠀⠀⠻⣦⣀⠀⠀⠀⠀⠉⠉⠒⠒ ⠀ ⠻⣦ ⠛⠛⠛⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠉⠒⠒⠈⠉⠛⠛⠛⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀    ⠉⠉⠒⠒⠀⠀⠀⠀
            ...
            for i in range(joystick_count):                   #⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣤⣤⣤⣀⡀⠀⠀⠀ ⠀⢀⣀⣤⣤⣤⣀⡀⠀⠀⠀⢀⣀⣤⣤⣤⣀⡀⠀⠀⠀              
                ...
                joystick.init()                               #⠀⠀⠀⠀⠀⠀⠀     
                self._joysticks.append(joystick)              # =      WHATLE WHALE WHALE..WHAT DO WE HAVE HERE?                       ⠀⠀⠀
                caps = {                                      # DO  ⠀⣀⣠⣤        ⣠   ⠀⠀ ⠀⠻⣦⣀⠀ ⠀⠀⠀   ⠀⠻    ⠀ ⠀         ⣀⣠⠤⢾⣞⣿⣿⣿⣶
                    "index": i,                               # NOT     ⠈  ⠉⠛⠛⠛  ⠀ ⠀⠀⠀⠀⠀                    ⠀⠀⠀⣀⡤⠔⠚ ⠉⢁⣤⣶⣾⣿⣟⠻⢇⣿
                    "id": joystick.get_instance_id(),         # ERASE            ⠀⠀  ⠀⠀  ⠀⠀⠀ ⠀⠀⠀⠀⠀⠀ ⠀⠀⠀⠀⣀⡤⠒⠋⠉⠀⠀⠀⣠⣶⣿⣿⡿⢋⡴⠟⣾⡾⠉
                    "name": joystick.get_name(),           #    THIS            ⠀⠀  ⠀ ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ ⠀ ⣀⡴⠚⠁⠀⠀⠀⠀⣠⣴⣾⣿⢟⡿⢋⡴⠛⣠⢾⠏⠁⠀
                    "guid": joystick.get_guid(),        #⡶   #         ⢀⡶⡄  ⠀  ⠀⠀     ⠀ ⠀⠀⠀⠀⠀⠀⠀⢀⡴⠋⠀(O)⣤⢶⣶⣾⡟⢠⠋⢠⠏⡰⢻⠋⡠⢋⡞⠁⠀⠀⠀⠀
    ...
    def process_commands(self, player_carla_actor, args):
        ...
        if not self._seatbelt_state:
            self.world.hud.warning_manager.add_warning('seatbelt','SAFETY VIOLATION: SEATBELT OFF', is_critical_center=False)
        ...
        while self._command_queue:
            ...
            if command["type"] == "axis":
                ...
                if action == "activate_left_blinker":
                    ...
                    iLib.ilog("info", f"🚦 Left blinker: {old_state} -> {self._blinker_state}",'items','js')
                    ...
                    iLib.ilog("info", f"🚦 Right blinker: {old_state} -> {self._blinker_state}",'items','js')
