        ...
        if carla and hasattr(carla, "CityObjectLabel"):
            for k in dir(carla.CityObjectLabel):
                ...
                try:
                    ...
                    self.name_to_id[k.lower()] = v  # FIXED: was name_ti_id
                except Exception:
                    pass
        self.occlusion_check_enabled = False
        self.min_visible_pixels = 100
        self.min_visibility_ratio = 0.15  # FIXED: was min_visibility_ration
    # --- Public --------------------------------------------------------------
